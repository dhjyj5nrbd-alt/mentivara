    ...
    <div className="min-h-screen bg-white dark:bg-[#0f1117]">
      ...
      <header className="border-b border-slate-100 dark:border-slate-800">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 flex items-center justify-between h-16">
          <span className="text-xl font-bold text-[#1E1B4B] dark:text-white">Mentivara</span>
          <div className="flex items-center gap-3">
            {isAuthenticated ? (
              <Link to="/dashboard" className="px-4 py-2 bg-[#7C3AED] text-white text-sm rounded-lg font-medium">Dashboard</Link>
            ) : (
              <>
                <Link to="/login" className="text-sm text-slate-600 dark:text-slate-400 hover:text-slate-900 dark:hover:text-white font-medium">Sign In</Link>
      ...
      <section className="max-w-6xl mx-auto px-4 sm:px-6 py-20 sm:py-28 text-center">
        ...
        <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-[#1E1B4B] dark:text-white leading-tight max-w-3xl mx-auto">
      ...
      <section className="py-20 text-center">
        <div className="max-w-3xl mx-auto px-4 sm:px-6">
          <h2 className="text-3xl font-bold text-[#1E1B4B] dark:text-white mb-4">Ready to level up your learning?</h2>
          <p className="text-slate-600 dark:text-slate-400 mb-8">Join students who are achieving their academic goals with Mentivara.</p>
