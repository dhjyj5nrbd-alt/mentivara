  ...
  return (
    <Layout>
      <div className="max-w-3xl mx-auto px-4 py-8">
        <h1 className="text-2xl font-bold text-[#1E1B4B] dark:text-white mb-2">Knowledge Map</h1>
        <p className="text-slate-600 dark:text-slate-400 mb-6">Track your mastery across topics. Complete exams to update your map.</p>
